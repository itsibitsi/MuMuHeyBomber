--[[ This is my First Script be patient im tryharding atm to learn everythink about Scripting ]]--
...
function AfterDownload()
	...
	if lib_downloadCount == 0 then
		...
		print("<font color=\"#FF0000\">Ziggs - The MuMyBomber:</font> <font color=\"#FFFFFF\">Required libraries downloaded successfully, please reload (double F9).</font>")
	end
end
...
function Menu()
	ZiggsMenu = scriptConfig("Ziggs - The TheMuMyBomber", "Ziggs")
